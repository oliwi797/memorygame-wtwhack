...
def show_console_credits():
    ...
    credits_lines = [
        ...
        ("", ""),
        ("CONSOLE CONQUEST", Colors.FIREWORKS_PRIMARY),
        ("", ""),
        ("", ""),
        ("In a terminal far, far away...", Colors.GREY_200),
        ("Card matches await discovery", Colors.GREY_200),
        ("in the depths of space.", Colors.GREY_200),
        ("", ""),
        ("The WTW ultraviolet terminal", Colors.GREY_200),
        ("provides the only hope for", Colors.GREY_200),
        ("memory masters everywhere.", Colors.GREY_200),
        ("", ""),
        ("Fun fact: C-3PO once tried", Colors.GREY_200),
        ("to play this game but kept", Colors.GREY_200),
        ("calculating the odds instead", Colors.SUCCESS_PRIMARY),
        ("of making matches! 🤖", Colors.SUCCESS_PRIMARY),
        ("", ""),
        ("WTW Console Edition", Colors.ULTRAVIOLET_PRIMARY),
        ("Terminal Warriors Welcome", Colors.ULTRAVIOLET_LIGHT),
        ("", ""),
        ("The Force is strong with this one!", Colors.FIREWORKS_PRIMARY),
        ("", ""),
    ]
