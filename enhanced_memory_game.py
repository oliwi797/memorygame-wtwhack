...
COLORS = {
    'background': (25, 35, 55),           # Dark blue background
    'card_back': (65, 105, 225),          # Royal blue
    'card_front': (248, 248, 255),        # Ghost white
    'card_hover': (100, 149, 237),        # Cornflower blue
    'card_matched': (50, 205, 50),        # Lime green
    'card_border': (30, 30, 30),          # Dark gray
    'text_primary': (255, 255, 255),      # White
    'text_secondary': (220, 220, 220),    # Light gray
    'accent': (255, 215, 0),              # Gold
    'success': (46, 204, 113),            # Emerald
    'warning': (241, 196, 15),            # Yellow
    'error': (231, 76, 60),               # Red
    'particle': (255, 255, 100),          # Light yellow
}
...
class Particle:
    ...
    def draw(self, screen):
        ...
        if alpha > 0:
            color = (*COLORS['particle'], int(alpha * 255))
...
class Card:
    ...
    def draw(self, screen, font, small_font):
        ...
        if show_front and scaled_width > 20:
            ...
            star_color = COLORS['accent'] if self.is_hovered else COLORS['text_primary']
...
class LoadingScreen:
    ...
    def draw(self, message="Loading Star Wars characters"):
        ...
        # Title
        title = self.title_font.render("Star Wars Memory Game", True, COLORS['accent'])
...
class MemoryGame:
    ...
    def draw_enhanced_ui(self):
        ...
        title_text = self.title_font.render("Star Wars Memory Game", True, COLORS['accent'])
        ...
        if self.combo_count > 1:
            ...
            combo_color = COLORS['accent'] if self.combo_count < 5 else COLORS['success']
    ...
    def draw_win_screen(self):
        ...
        # Win message
        win_text = self.large_font.render("Victory!", True, COLORS['accent'])
